...
import zixin.socket.handler.SuccessAuthorizationListener;
import zixin.socket.listener.DefaultExceptionListener;
import zixin.socket.listener.ExceptionListener;
import zixin.socket.protocol.JsonSupport;
import zixin.socket.store.MemoryStoreFactory;
...
public class Configuration {
    ...
    Configuration(Configuration conf) {
        ...
        if (conf.getJsonSupport() == null) {
            try {
                ...
                try {
                    Class<?> jjs = getClass().getClassLoader().loadClass("zixin.socket.protocol.JacksonJsonSupport");
     ...
     *
     * @see zixin.socket.store.MemoryStoreFactory
     * @see zixin.socket.store.RedissonStoreFactory
     * @see zixin.socket.store.HazelcastStoreFactory
     */
     ...
     *
     * @see zixin.socket.AuthorizationListener
     */
     ...
     *
     * @see zixin.socket.listener.ExceptionListener
     */
